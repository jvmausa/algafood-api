...
public interface FluxoPedidoControllerOpenApi {
	...
	ResponseEntity<Void> confirmar(@ApiParam(value = "Código de um pedido", example = "1", required = true) 
					String codigoPedido);
	...
	ResponseEntity<Void> cancelar(@ApiParam(value = "Código de um pedido", example = "1", required = true) String codigoPedido);
	...
	ResponseEntity<Void> entrega(@ApiParam(value = "Código de um pedido", example = "1", required = true) String codigoPedido);
